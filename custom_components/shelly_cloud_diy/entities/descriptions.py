...
RPC_SENSORS: Final[dict[str, RpcSensorDescription]] = {
    ...
    # ------------------------------------------------------------------
    "em_a_act_power": RpcSensorDescription(
        key="em",
        sub_key="a_act_power",
    ...
    "em_a_aprt_power": RpcSensorDescription(
        key="em",
    ...
    "em_a_current": RpcSensorDescription(
        key="em",
        sub_key="a_current",
    ...
    "em_a_voltage": RpcSensorDescription(
        key="em",
        sub_key="a_voltage",
    ...
    "em_a_freq": RpcSensorDescription(
        key="em",
        sub_key="a_freq",
    ...
    "em_b_act_power": RpcSensorDescription(
        key="em",
        sub_key="b_act_power",
    ...
    "em_b_aprt_power": RpcSensorDescription(
        key="em",
    ...
    "em_b_current": RpcSensorDescription(
        key="em",
        sub_key="b_current",
    ...
    "em_b_voltage": RpcSensorDescription(
        key="em",
        sub_key="b_voltage",
    ...
    "em_b_freq": RpcSensorDescription(
        key="em",
        sub_key="b_freq",
    ...
    "em_c_act_power": RpcSensorDescription(
        key="em",
        sub_key="c_act_power",
    ...
    "em_c_aprt_power": RpcSensorDescription(
        key="em",
    ...
    "em_c_current": RpcSensorDescription(
        key="em",
        sub_key="c_current",
    ...
    "em_c_voltage": RpcSensorDescription(
        key="em",
        sub_key="c_voltage",
    ...
    "em_c_freq": RpcSensorDescription(
        key="em",
        sub_key="c_freq",
    ...
    "em_total_act_power": RpcSensorDescription(
        key="em",
    ...
    "em_total_aprt_power": RpcSensorDescription(
        key="em",
    ...
    "em_total_current": RpcSensorDescription(
        key="em",
    ...
    # ------------------------------------------------------------------
    # Energy Meter — cumulative energy counters (``emdata:<id>``).
    # Values are already in watt-hours; do not scale.
    # ------------------------------------------------------------------
    "emdata_a_total_act_energy": RpcSensorDescription(
        key="emdata",
    ...
    "emdata_a_total_act_ret_energy": RpcSensorDescription(
        key="emdata",
        sub_key="a_total_act_ret_energy",
        name="Phase A Returned Energy",
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        suggested_display_precision=2,
    ),
    "emdata_b_total_act_energy": RpcSensorDescription(
        key="emdata",
    ...
    "emdata_b_total_act_ret_energy": RpcSensorDescription(
        key="emdata",
        sub_key="b_total_act_ret_energy",
        name="Phase B Returned Energy",
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        suggested_display_precision=2,
    ),
    "emdata_c_total_act_energy": RpcSensorDescription(
        key="emdata",
    ...
    "emdata_c_total_act_ret_energy": RpcSensorDescription(
        key="emdata",
        sub_key="c_total_act_ret_energy",
        name="Phase C Returned Energy",
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        suggested_display_precision=2,
    ),
    "emdata_total_act": RpcSensorDescription(
        key="emdata",
        sub_key="total_act",
        name="Total Energy",
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
    ...
    "emdata_total_act_ret": RpcSensorDescription(
        key="emdata",
